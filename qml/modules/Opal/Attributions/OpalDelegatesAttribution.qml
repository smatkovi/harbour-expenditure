...
//@ SPDX-FileCopyrightText: 2023 Peter G. (nephros):2024 Mirian Margiani (ichthyosaurus)
//@ SPDX-License-Identifier: GPL-3.0-or-later
import"../../Opal/About"as A
A.Attribution{name:"Opal.Delegates (v3.0.0)"
entries:"2023 Peter G. (nephros):2024 Mirian Margiani (ichthyosaurus)"
